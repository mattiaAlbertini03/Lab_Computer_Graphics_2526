...
var texcoords = [
	...
	0.5,  0.66,  0.25, 0.66,   0.25, 0.34,  0.5,  0.34,  //bottom  V
	0.75, 0.66,  1.0,  0.66,   1.0,  0.34,  0.75, 0.34,  //top     V
	0.5,  0.66,  0.5,  0.34,  0.75, 0.34,  0.75, 0.66,  //back    V
	0.25, 0.66,  0.25, 0.34,  0.0,  0.34,  0.0,  0.66,  //front   V
	0.499,  0.665,  0.499, 1.0,   0.251, 1.0,  0.251, 0.665,  //sx      V
	0.499,  0.335,  0.499, 0.0,   0.251, 0.0,  0.251, 0.335,  //dx     V
];
...
/*=================== SHADERS =================== */
var programInfo = webglUtils.createProgramInfo(gl, ["vertex-shader3", "fragment-shader3"]);
...
var animate=function(time) {
	...
	var up = [0, 0, 1];
	var target = [0, 0, 0];
	var view_matrix = m4.inverse(m4.lookAt(target, cameraPosition, up));
	let shared1Uniforms = {
		Vmatrix: view_matrix,
		Pmatrix: proj_matrix,
	};
